 ...
 */
final class Version20210721160445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, title VARCHAR(255) NOT NULL, country VARCHAR(3) NOT NULL, original_title VARCHAR(250) DEFAULT NULL, description TEXT NOT NULL, ranking SMALLINT NOT NULL, price NUMERIC(7, 2) NOT NULL, product_type VARCHAR(255) CHECK(product_type IN (\'book\', \'ebook\', \'audio-book\')) NOT NULL, PRIMARY KEY(id))');
